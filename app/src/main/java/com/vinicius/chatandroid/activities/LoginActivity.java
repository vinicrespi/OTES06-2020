...
import com.vinicius.chatandroid.Application;
import com.vinicius.chatandroid.R;
import com.vinicius.chatandroid.db.DBHelper;
        ...
        btnlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Thread r = new Thread() {
                    @Override
                    public void run() {
                        Application.getInstance().enviarMensagemLogin(username.getText().toString());
                    }
                };
                r.start();
                ...
                if(user.equals("")||pass.equals(""))
                    ...
                    if(checkuserpass==true){
                        ...
                        String parametros = "Welcome, "+user;
